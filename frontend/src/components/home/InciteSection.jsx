  ...
  return (
    <div className="flex flex-col md:flex-row mx-0 w-full my-0 h-auto lg:min-h-[500px]">
      <div className='md:w-1/2 w-full md:h-[500px] h-[500px] relative'>
        <div className='absolute bg-orange-600 h-full w-full flex flex-col text-white justify-center items-start gap-5 p-10'>
      ...
      <div className='md:w-1/2 md:h-[500px] h-[500px] relative'>
        <div className='absolute h-full w-full flex flex-col justify-center items-start gap-5 p-10'>

const Actu = (props) => {
  ...
  return (
    <div className="flex flex-col justify-between  p-4 my-4 mx-auto border border-gray-300 rounded-lg  shadow-[0_0_15px_rgba(0,0,0,0.1)] h-[170px] w-[70%] md:w-[45%] lg:w-[20%]">

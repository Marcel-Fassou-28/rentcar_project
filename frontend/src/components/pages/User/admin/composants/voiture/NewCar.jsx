...
import { form, s } from "framer-motion/client";
...
const ModifierCar = () => {
  ...
  return (
    <div className="flex  pt-16 ">
      ...
      <div className="ml-4 mb-4  flex-[4] flex-col items-center lg:flex-row ">
        <div className=" bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl shadow-lg p-6  text-white mx-aut mt-4 w-[95%] md:w-[90%] lg:w-[97%]   ">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <h1 className="text-3xl font-bold mb-2">Nouvelle la Voiture </h1>
            <p className="text-orange-100">
              entrer les informations de la voiture dans le
        ...
        <div className="  flex flex-col lg:flex-row  gap-4 ">
          ...
          <form
            ...
            className=" flex flex-wrap justify-between  shadow-[0_0_15px_rgba(0,0,0,0.1)] w-[90%]  lg:w-[50%] rounded flex gap-4 p-8  lg:mt-6 lg:mx-auto mt-8  "
          >
            {error && (
